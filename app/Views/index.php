...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <!-- Sidebar Start -->
  <aside class="left-sidebar" style="top:0; height:100vh; border-top-left-radius:0; border-top-right-radius:0;">
      <!-- Sidebar scroll-->
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="<?php echo base_url('index.php')?>" class="text-nowrap logo-img">
            <img src="<?= base_url('spike/src/assets/images/logos/logo.svg') ?>" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link primary-hover-bg" href="<?php echo base_url('index.php') ?>" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link primary-hover-bg" href="<?php echo base_url('pemasukan') ?>" aria-expanded="false">
                <iconify-icon icon="solar:layers-minimalistic-bold-duotone"></iconify-icon>
                <span class="hide-menu">Pemasukan</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link primary-hover-bg" href="<?php echo base_url('pengeluaran') ?>" aria-expanded="false">
                <iconify-icon icon="solar:danger-circle-line-duotone"></iconify-icon>
                <span class="hide-menu">Pengeluaran</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link primary-hover-bg" href="<?php echo base_url('barang') ?>" aria-expanded="false">
        ...
        <div class="container-fluid">
                ...
                <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link " href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                      aria-expanded="false">
                      <img src="<?= base_url('spike/src/assets/images/profile/user1.jpg') ?>" alt="" width="35" height="35"
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="me-4">
                                <img src="<?= base_url('spike/src/assets/images/profile/user1.jpg') ?>" width="50" class="rounded-circle"
                                  alt="" />
                              </div>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="me-4">
                                <img src="<?= base_url('spike/src/assets/images/profile/user2.jpg') ?>" width="50" class="rounded-circle"
                                  alt="" />
                              </div>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="me-4">
                                <img src="<?= base_url('spike/src/assets/images/profile/user3.jpg') ?>" width="50" class="rounded-circle"
                                  alt="" />
                              </div>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="me-4">
                                <img src="<?= base_url('spike/src/assets/images/profile/user4.jpg') ?>" width="50" class="rounded-circle"
                                  alt="" />
                              </div>
          ...
          <div class="row">
            <div class="col-sm-6 col-xl-3">
              <div class="card overflow-hidden">
                <div class="position-relative">
                  <a href="javascript:void(0)"><img src="<?= base_url('spike/src/assets/images/products/s4.jpg') ?>"
            ...
            <div class="col-sm-6 col-xl-3">
              <div class="card overflow-hidden">
                <div class="position-relative">
                  <a href="javascript:void(0)"><img src="<?= base_url('spike/src/assets/images/products/s5.jpg') ?>"
                      class="card-img-top rounded-0" alt="..."></a>
                  <a href="javascript:void(0)"
                    class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                    data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
            ...
            <div class="col-sm-6 col-xl-3">
              <div class="card overflow-hidden">
                <div class="position-relative">
                  <a href="javascript:void(0)"><img src="<?= base_url('spike/src/assets/images/products/s7.jpg   ') ?>"
                      class="card-img-top rounded-0" alt="..."></a>
                  <a href="javascript:void(0)"
                    class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                    data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
            ...
            <div class="col-sm-6 col-xl-3">
              <div class="card overflow-hidden">
                <div class="position-relative">
                  <a href="javascript:void(0)"><img src="<?= base_url('spike/src/assets/images/products/s11.jpg') ?>"
                      class="card-img-top rounded-0" alt="..."></a>
                  <a href="javascript:void(0)"
                    class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                    data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i
